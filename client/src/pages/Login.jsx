...
const Login = () => {
    ...
    const handleGoogleSignIn = async () => {
        ...
        // 2. Prompt for Email ID and verify employee email availability before proceeding
        const { value: enteredEmail } = await Swal.fire({
            title: `
                <div class="flex flex-col items-center gap-2">
                    ...
                    <span class="text-xl font-bold text-gray-800">Continue with Google</span>
                </div>
            `,
            html: `
                <p class="text-xs text-gray-500 mb-3">Enter your registered employee email ID to continue:</p>
            `,
            input: 'email',
            inputValue: '',
            ...
            customClass: {
                ...
                confirmButton: 'font-semibold px-6 py-2.5 rounded-xl text-sm',
                cancelButton: 'font-semibold px-6 py-2.5 rounded-xl text-sm',
                input: 'rounded-xl border-gray-300 focus:ring-blue-500 text-sm py-2.5'
            },
        ...
        processGoogleAuthPayload({ email: enteredEmail.trim() });
    };

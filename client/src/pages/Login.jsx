        ...
        const { value: selectedEmail } = await Swal.fire({
            title: `
                <div class="flex flex-col items-center gap-2">
                    ...
                    <span class="text-xl font-bold text-gray-800">Sign In with Google</span>
                </div>
            `,
            html: `
                <p class="text-xs text-gray-600 mb-3">Please enter your registered Google Email ID to access the dashboard:</p>
            `,
            input: 'email',
            inputValue: '',
            inputPlaceholder: 'your.name@ppg.edu.in',

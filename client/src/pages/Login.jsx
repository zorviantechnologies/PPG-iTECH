            ...
            >
                ...
                <div className="space-y-4 mb-6">
                    ...
                    >
                        ...
                        <span className="tracking-wide">Sign In with Google Account ID</span>
                    </motion.button>

                    <p className="text-[11px] text-sky-200/90 text-center font-medium leading-relaxed px-2">
                        🔒 Click to log in with your Google email. Access is allowed only if your email exists in the <span className="font-bold text-white">user_login</span> database table.
                    </p>
                </div>
                ...
                {/* Secondary Employee Email Login Form */}

...
const Login = () => {
    ...
    const handleGoogleSignIn = async () => {
        ...
        setLoading(true);
        try {
            const data = await googleLogin(selectedEmail.trim());
        ...
        <div className="min-h-screen w-full flex items-center justify-center p-4 relative overflow-hidden">
            ...
            >
                ...
                <form onSubmit={handleEmailSignIn} className="space-y-4">
                    <div>
                        <label className="block text-[11px] font-bold text-sky-100 uppercase tracking-wider mb-1 px-1">
                    ...
                    <div>
                        <label className="block text-[11px] font-bold text-sky-100 uppercase tracking-wider mb-1 px-1">
                            Password / PIN <span className="text-[9px] text-sky-300 font-normal">(Optional if default)</span>
                        </label>
                        <div className="relative flex items-center">
                            <Lock className="absolute left-3.5 text-sky-300 pointer-events-none" size={18} />
                            <input
                                type="password"
                                value={pin}

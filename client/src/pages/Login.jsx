...
const Login = () => {
    ...
    const handleGoogleSignIn = async () => {
        // Prompt for Google account email address
        const { value: selectedEmail } = await Swal.fire({
                title: `
                    <div class="flex flex-col items-center gap-2">
                        ...
                        <span class="text-xl font-bold text-gray-800">Continue with Google Account</span>
                    </div>
                `,
                html: `
                    <p class="text-xs text-gray-500 mb-3">Enter or select your registered Google email address to log in:</p>
                ...
                confirmButtonText: 'Continue with Google Email',
                confirmButtonColor: '#2563eb',

...
const Login = () => {
    ...
    const handleGoogleSignIn = async () => {
        const { value: email } = await Swal.fire({
            ...
            text: 'Enter your registered Google Email address to login:',
            input: 'email',
            inputPlaceholder: 'employee@ppg.edu.in',
        ...
        try {
            ...
            Swal.fire({
                icon: 'success',
                title: 'Welcome Back!',
                text: `Successfully logged in as ${data.name} (${data.role.toUpperCase()})`,
                timer: 1500,
            ...
            setLoading(false);
            const errorMessage = error.response?.data?.message || 'Access Denied: Email not registered with an employee account.';
            Swal.fire({
                icon: 'error',
                title: 'Login Failed',
                text: errorMessage,
